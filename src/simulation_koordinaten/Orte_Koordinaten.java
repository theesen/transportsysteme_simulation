...
public class Orte_Koordinaten {
   ...
   // for (int i=0;i < anzahl_orte;i++){
    ...
    //}
	    ...
	    Coordinate coordinate = new Coordinate(7.1645575549788445, 53.62341880951364);  
	    ...
	    orte_koordinaten[0][2]= "Orte";
	     ...
	     coordinate = new Coordinate(7.1645575549788445, 53.62341880951364); 
	     coordinate = new Coordinate(7.105547171409061, 53.71942776690892); 
