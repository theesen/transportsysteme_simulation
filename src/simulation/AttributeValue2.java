 ...
 *
 */
public class AttributeValue2 implements java.io.Serializable
{
...
//    private String name;
    ...
    public AttributeValue2(Object v)
    {
        this(v, 0, false);
    }
    ...
    public AttributeValue2(Object v, int f, boolean h)
    {
//        name = n;
        value = v;
        hidden = h;
...
//        AttributeValue a = new AttributeValue(getName(), getValue(), getFieldSize(), isHidden());
        AttributeValue2 a = new AttributeValue2(getValue(), getFieldSize(), isHidden());
        return a;
    }
...
//    }
    ...
    public boolean equals(Object obj)
    {
        ...
        final AttributeValue2 other = (AttributeValue2) obj;
